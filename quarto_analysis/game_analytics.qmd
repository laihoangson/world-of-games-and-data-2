...
To tackle the challenge of a limited dataset without introducing bias or overfitting, this study employs K-Fold Cross-Validation for robust machine learning evaluation. This foundation allows me to segment the player base into distinct behavioral profiles using unsupervised learning (K-Means Clustering), revealing clear archetypes from hesitant Beginners to seasoned Experts.

The core of this investigation lies in supervised predictive modeling. I develop and compare multiple algorithms to:

- Predict final scores based on gameplay behavior.

- Forecast player survival beyond a critical 30-second threshold.

- Anticipate the cause of a player's death through classification modeling.
